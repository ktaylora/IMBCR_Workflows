...
r_gcam_45_rcp45_2014 <- raster::raster(
    "/global_workspace/terry_sohl_sres_btu_30m_landcover_predictions/extracted/gplcc_gcam_45_rcp45_2014.tif"
  )
  
r_gcam_45_rcp45_2050 <- raster::raster(
    "/global_workspace/terry_sohl_sres_btu_30m_landcover_predictions/extracted/gplcc_gcam_45_rcp45_2050.tif"
  )

r_gcam_45_rcp45_2100 <- raster::raster(
    "/global_workspace/terry_sohl_sres_btu_30m_landcover_predictions/extracted/gplcc_gcam_45_rcp45_2100.tif"
  )
